...
public class CameraSource2 {
    ...
    public com.zgty.oarobot.util.CameraSource2 start() throws IOException {
        Object var1 = this.aDD;
        synchronized(this.aDD) {
            if(this.aDE != null) {
                return this;
    ...
    @SuppressLint("MissingPermission")
    @RequiresPermission("android.permission.CAMERA")
    public CameraSource2 start(SurfaceHolder var1) throws IOException {
    ...
    public void takePicture(CameraSource2.ShutterCallback var1, CameraSource2.PictureCallback var2) {
        Object var3 = this.aDD;
        synchronized(this.aDD) {
            if(this.aDE != null) {
                CameraSource2.zzd var4 = new CameraSource2.zzd();
                var4.aDZ = var1;
                CameraSource2.zzc var5 = new CameraSource2.zzc();
                var5.aDY = var2;
    ...
    private Camera zzchq() {
        ...
        if(var1 == -1) {
            ...
            CameraSource2.zze var3 = zza(var2, this.aDI, this.aDJ);
            if(var3 == null) {
                ...
                if(var5 == null) {
                    ...
                    var2.setPreviewCallbackWithBuffer(new CameraSource2.zza());
    ...
    static CameraSource2.zze zza(Camera var0, int var1, int var2) {
        List var3 = zza(var0);
        CameraSource2.zze var4 = null;
        int var5 = 2147483647;
        Iterator var6 = var3.iterator();

        while(var6.hasNext()) {
            CameraSource2.zze var7 = (CameraSource2.zze)var6.next();
    ...
    static List<CameraSource2.zze> zza(Camera var0) {
        ...
        while(true) {
            ...
            while(var5.hasNext()) {
                ...
                while(var8.hasNext()) {
                    ...
                    if(Math.abs(var7 - var10) < 0.01F) {
                        var4.add(new CameraSource2.zze(var6, var9));
                        break;
                    }
                }
            }
            ...
            if(var4.size() == 0) {
                ...
                while(var5.hasNext()) {
                    var6 = (android.hardware.Camera.Size)var5.next();
                    var4.add(new CameraSource2.zze(var6, (android.hardware.Camera.Size)null));
                }
            }
    ...
    private class zzb implements Runnable {
        ...
        @SuppressLint({"Assert"})
        void release() {
            assert CameraSource2.this.aDO.getState() == State.TERMINATED;
        ...
        void zza(byte[] var1, Camera var2) {
            ...
            synchronized(this.zzail) {
                ...
                if(!CameraSource2.this.aDQ.containsKey(var1)) {
                    Log.d("CameraSource", "Skipping frame. Could not find ByteBuffer associated with the image data from the camera.");
                } else {
                    this.aDV = SystemClock.elapsedRealtime() - this.zzczg;
                    ++this.aDW;
                    this.aDX = (ByteBuffer) CameraSource2.this.aDQ.get(var1);
                    this.zzail.notifyAll();
                }
            }
        }
        ...
        public void run() {
            while(true) {
                ...
                synchronized(this.zzail) {
                    ...
                    var1 = (new com.google.android.gms.vision.Frame.Builder()).setImageData(this.aDX, CameraSource2.this.aDG.getWidth(), CameraSource2.this.aDG.getHeight(), 17).setId(this.aDW).setTimestampMillis(this.aDV).setRotation(CameraSource2.this.zzbrh).build();
                    var2 = this.aDX;
                    this.aDX = null;
                }
                ...
                try {
                    ...
                    CameraSource2.this.aDE.addCallbackBuffer(var2.array());
                }
            }
        }
    }
    ...
    private class zza implements PreviewCallback {
        ...
        public void onPreviewFrame(byte[] var1, Camera var2) {
            CameraSource2.this.aDP.zza(var1, var2);
        }
    }
    ...
    private class zzc implements android.hardware.Camera.PictureCallback {
        private CameraSource2.PictureCallback aDY;
        ...
        public void onPictureTaken(byte[] var1, Camera var2) {
            ...
            synchronized(CameraSource2.this.aDD) {
                if(CameraSource2.this.aDE != null) {
                    CameraSource2.this.aDE.startPreview();
                }
    ...
    private class zzd implements android.hardware.Camera.ShutterCallback {
        private CameraSource2.ShutterCallback aDZ;
    ...
    public static class Builder {
        ...
        private CameraSource2 aDS = new CameraSource2();
        ...
        public CameraSource2.Builder setRequestedFps(float var1) {
            if(var1 <= 0.0F) {
        ...
        public CameraSource2.Builder setRequestedPreviewSize(int var1, int var2) {
            int var3 = 1000000;
        ...
        public CameraSource2.Builder setFacing(int var1) {
            if(var1 != 0 && var1 != 1) {
        ...
        public CameraSource2.Builder setAutoFocusEnabled(boolean var1) {
            this.aDS.aDK = var1;
            return this;
        }

        public CameraSource2 build() {
            CameraSource2 var10000 = this.aDS;
            CameraSource2 var10003 = this.aDS;
            this.aDS.getClass();
